                ...
                <div className="text-center">
                    <button className="button-link mt-5" onClick={onCountHandle}>
                        {count < projects.length ?
                            "Show more"
                            :
                            <Link onClick={onCountHandle} to="Projects" spy={true} smooth={true} offset={-70} duration={500}>Show Less</Link>}
                    </button>
                </div>
            </>
        )
    ...
    return (
        <div className="">
            ...
            <div className="project-listing">
                <div className="my-4" data-aos="fade-up" data-aos-delay="150" data-aos-once="true" data-aos-duration="1200">
                    <div id="Projects" className="subsection-title mb-5">Other Interesting Projects</div>
